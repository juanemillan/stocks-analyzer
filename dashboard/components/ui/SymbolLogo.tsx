...
function canonicalSymbol(raw: string) {
  ...
  // Keep common tickers like BRK.B; strip suffixes like "AMZN:US" / "AMZN US" / "AMZN-USD" (fallbacks to full string)
  ...
  if (failed) {
    return (
      <div
        ...
        style={{ width: size, height: size, fontSize: size * 0.4, backgroundColor: pickColor(sym) }}
        aria-label={sym}
      >
        {sym.charAt(0)}
      </div>
