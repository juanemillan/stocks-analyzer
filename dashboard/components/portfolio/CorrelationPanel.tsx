...
export function CorrelationPanel({ data }: CorrelationPanelProps) {
  ...
  return (
    <div className="mt-8 space-y-4">
      ...
      <div className="flex items-center gap-5 rounded-2xl border bg-white dark:bg-neutral-900 px-5 py-4">
        {/* Score circle */}
        <div className={`w-16 h-16 rounded-full ring-4 ${grade.ring} flex flex-col items-center justify-center flex-none`}>
          <span className={`text-2xl font-bold tabular-nums leading-none ${grade.color}`}>{score}</span>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">{grade.text}</p>
          {hasWarnings && (
      ...
      <div className="rounded-2xl border bg-white dark:bg-neutral-900 px-5 py-4">
        <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
          <svg width="15" height="15" viewBox="0 0 20 20" fill="currentColor" className="text-emerald-500"><path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.381z" clipRule="evenodd"/></svg>
      ...
      <div className="rounded-2xl border bg-white dark:bg-neutral-900 overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between px-5 py-3.5 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors"
        >
          <span className="flex items-center gap-2">
            <svg width="15" height="15" viewBox="0 0 20 20" fill="currentColor" className="text-blue-400"><path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"/></svg>
