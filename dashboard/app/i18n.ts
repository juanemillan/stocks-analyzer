...
export const LABELS = {
  ...
  tabDiary:          { es: "Diario",           en: "Diary" },
  tabPortfolio:      { es: "Mi Portfolio",     en: "My Portfolio" },
  diaryTitle:        { es: "Diario de mercado", en: "Market Diary" },
  diarySubtitle:     { es: "Resumen diario del mercado generado por el pipeline nocturno.", en: "Daily market snapshot generated by the nightly pipeline." },
  diaryLoading:      { es: "Cargando diario…", en: "Loading diary…" },
  diaryEmpty:        { es: "Todavía no hay entradas en daily_insights.", en: "There are no daily_insights entries yet." },
  diaryLatest:       { es: "Última entrada",   en: "Latest entry" },
  diaryHistory:      { es: "Historial reciente", en: "Recent history" },
  diarySentiment:    { es: "Sentimiento",      en: "Sentiment" },
  diarySummary:      { es: "Resumen",          en: "Summary" },
  diaryAIInsight:    { es: "Insight de IA",    en: "AI Insight" },
  diaryStats:        { es: "Métricas",         en: "Metrics" },
  diaryVersion:      { es: "Versión",          en: "Version" },
  diaryAssetsCount:  { es: "Activos analizados", en: "Assets analyzed" },
  diaryAvgScore:     { es: "Score promedio",   en: "Average score" },
